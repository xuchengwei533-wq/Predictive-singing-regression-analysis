...
feature_dir = os.path.join(data_dir, "F0_PYIN_Output")
...
if xs.size == 0:
    raise RuntimeError("没有可用样本，请确认 F0_PYIN_Output 已生成")
...
plt.xlabel("Score")
plt.ylabel("F0 Pyin Median")
plt.tight_layout()
out_path = os.path.join(output_dir, "F0Pyin_median_by_score.png")
