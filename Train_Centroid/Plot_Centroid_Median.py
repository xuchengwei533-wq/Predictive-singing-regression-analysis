...
output_dir = r"D:\同济车辆\chest_audio\Train_Centroid"
os.makedirs(output_dir, exist_ok=True)

feature_dir = os.path.join(data_dir, "Spectral_Centroid_Output")
...
if xs.size == 0:
    raise RuntimeError("没有可用样本，请确认 Spectral_Centroid_Output 已生成")
...
plt.tight_layout()
out_path = os.path.join(output_dir, "Centroid_median_by_score.png")
